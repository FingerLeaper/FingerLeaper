...
var cur_app_focus = 0;
var frameRate = 100;
var countdown_length = 3 * frameRate;
var cur_countdown_status = countdown_length;
var app_length = 100000;
...
// draw fingers
var phalanges = [];
var len = [21, 15, 16, 18, 16, 18, 16, 17, 16, 16];
var width = 6;
var gap_joint = 1;
...
var phalange_position = [palm_size[1]/2+gap_finger+width/2,0,0,
                palm_size[1]/2+gap_finger+width/2,0,-(len[0]/2+gap_joint+len[1]/2),

                palm_size[1]/2-width/2,0,-(palm_size[0]/2+gap_joint+len[2]/2),
                palm_size[1]/2-width/2,0,-(palm_size[0]/2+2*gap_joint+len[2]*1.5),

                width/2+gap_finger/2,0,-(palm_size[0]/2+gap_joint+len[4]/2),
                width/2+gap_finger/2,0,-(palm_size[0]/2+2*gap_joint+len[4]*1.5),

                -width/2-gap_finger/2,0,-(palm_size[0]/2+gap_joint+len[6]/2),
                -width/2-gap_finger/2,0,-(palm_size[0]/2+2*gap_joint+len[6]*1.5),

                -palm_size[1]/2+width/2,0,-(palm_size[0]/2+gap_joint+len[8]/2),
                -palm_size[1]/2+width/2,0,-(palm_size[0]/2+2*gap_joint+len[8]*1.5)];
